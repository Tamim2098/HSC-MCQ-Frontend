...
const subjectStyles = {
  physics: { iconColor: 'text-indigo-400' },
  chemistry: { iconColor: 'text-teal-400' },
  math: { iconColor: 'text-orange-400' },
  biology: { iconColor: 'text-green-400' },
...
        [@media(hover:hover)]:hover:ring-offset-gray-950`}
    >
      <motion.div
        animate={{ y: [0, -4, 0] }}
        transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
        className={`p-4 rounded-full bg-gray-700 ${iconColor} mb-3`}
      >
...
            className="w-full max-w-xl p-4 mb-8 relative z-10 bg-gray-800/50 backdrop-blur-md rounded-lg shadow-xl border border-gray-700/50 text-gray-100"
          >
...
                className="ml-4 p-1 rounded-full text-gray-400 hover:text-gray-200 hover:bg-gray-700 transition-colors duration-200"
