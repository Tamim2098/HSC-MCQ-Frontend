...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-black transition-colors duration-500 p-8 flex items-center justify-center overflow-hidden relative">
      <div className="absolute inset-0 z-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
      
      <div className="absolute top-1/2 left-1/2 w-96 h-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-700/10 blur-3xl animate-pulse-slow"></div>

      <motion.div
        variants={cardVariants}
        initial="hidden"
        animate="visible"
        className="relative z-10 bg-gray-800/30 backdrop-blur-md p-8 rounded-2xl shadow-2xl w-full max-w-sm border border-gray-700/50 transform transition-all duration-300 hover:shadow-3xl"
      >
        <motion.h2
...
              className="w-full px-4 py-3 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-gray-700 text-gray-100 transition-colors"
...
              className="text-red-400 text-sm font-medium text-center bg-red-900/50 p-3 rounded-xl border border-red-800"
            >
              {error}
            </motion.p>
          )}
